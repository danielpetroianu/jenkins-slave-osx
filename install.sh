...
DOWNLOADS_PATH=https://raw.github.com/danielpetroianu/jenkins-slave-osx/master
...
function create_user() {
	...
	SERVICE_WRKSPC=${SERVICE_HOME}/JENKINS_SLAVE_HOME
}
...
function configure_daemon {
	...
	MASTER_HTTP_PORT=`echo $MASTER | cut -d':' -f3 | cut -d'/' -f1` 
